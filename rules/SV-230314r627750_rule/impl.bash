...
# Severity:               CAT II
#
# Rule Version (STIG-ID): RHEL-08-010674
#
# Rule Title:             RHEL 8 must disable storing core dumps.
#


config_file="50-accident-stig-disable-coredump-storage.conf"
...
compliance --rule-id "SV-230314r627750_rule" --status "$compliance"
